...
const Page = () => {
  return (
    <div className="bg-background-neutral flex h-full w-full items-center justify-around">
      <div className="w-full max-w-md p-8">
        ...
        <form className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full rounded-xl bg-black px-4 py-3 font-medium text-white transition-colors hover:bg-gray-800"
          >
            Sign In
          </button>
